...
| Complete actionable artifacts and explicit correction overlays | [Orchestrator Mode child contracts](../../skills/active/orchestrator-mode/references/child-contracts.md#complete-artifact-handoffs) |
