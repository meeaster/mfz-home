...
Use the consumer's identity to calibrate terminology, prerequisite context,
detail, and tone. Derive actions, questions, and artifact sections from the
user's request and intended use.
