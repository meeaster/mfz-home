...
The [2026-09-22 redesign](redesign-2026-09-22.md#workspace-structure-and-ownership) replaces the earlier file layout and continuity policy below. The prior explanation is retained for historical context. Current evidence and operational-learning ownership are defined in [Task Evidence](../../skills/active/task-evidence/SKILL.md).
