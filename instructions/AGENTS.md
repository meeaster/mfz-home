...
- Use `explore`, `research`, and `inspect` proactively for bounded evidence gathering when materially useful. Use `session-analyst` whenever prior OpenCode or other AI-session evidence must be examined.
