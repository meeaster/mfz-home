...
- Human selection for a task or batch is explicit in the dispatch brief; the parent requires skill `orchestrator-mode` in parent-facing context and supplies decision-relevant context rather than assuming conversation or skills are inherited.
