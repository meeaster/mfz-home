...
**Scenario:** Only “Use super-worker for this task or batch” selects `super-worker` outside a loaded workflow. Difficulty, failed attempts, or a request for the strongest model does not.
