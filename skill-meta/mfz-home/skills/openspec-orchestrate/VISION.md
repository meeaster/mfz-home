...
The user should be able to see why the workflow chose its execution shape and where it stopped. Missing context, incomplete planning, ambiguous workspaces, and absent authorization produce visible blockers rather than guessed progress.
