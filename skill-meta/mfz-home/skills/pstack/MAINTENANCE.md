...
The plugin's development SDK must exactly match `opencode --version`. OpenCode 2 is stable. Check the client version, SDK declaration, plugin list, and live skill discovery before changing versions.
